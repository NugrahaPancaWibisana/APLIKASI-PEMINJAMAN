                        ...
                        <table class="w-full border-collapse">
                            <thead>
                                <tr class="bg-gray-100">
                                    ...
                                    <th class="p-3 text-sm font-semibold text-left text-gray-700">Tanggal Kembali</th>
                                    <th class="p-3 text-sm font-semibold text-left text-gray-700">Total Barang</th>
                                    <th class="p-3 text-sm font-semibold text-left text-gray-700">Barang Yang Dipinjam
                                    </th>
                            ...
                            <tbody>
                                            ...
                                            <div class="flex flex-wrap gap-1">
                                                @foreach ($item->items as $peminjamanItem)
                                                    <span class="px-2 py-1 text-xs text-white bg-blue-500 rounded-full">
                                                        {{ $peminjamanItem->barang->nama }}
                                                        ({{ $peminjamanItem->jumlah_barang }})
                                                    </span>
                                                @endforeach
                                            </div>
                                        </td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="p-10 text-lg text-center text-gray-600">
                                            Data Peminjaman Telah Dikembalikan Tidak Ditemukan
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
